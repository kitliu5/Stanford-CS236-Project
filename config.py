...
data_dir = '/Users/kit/Desktop/progressive_growing_of_gans-master/n16'
result_dir = '/Users/kit/Desktop/progressive_growing_of_gans-master/results'
...
# Dataset (choose one).
#desc += '-synew_v2';          dataset = EasyDict(tfrecord_dir='n16data_new'); train.mirror_augment = False
desc += '-n18_h';          dataset = EasyDict(tfrecord_dir='n18'); train.mirror_augment = False
...
desc += '-preset-v2-1gpu'; num_gpus = 1; sched.minibatch_base = 4; sched.minibatch_dict = {4: 128, 8: 128, 16: 128, 32: 64, 64: 32, 128: 16, 256: 8, 512: 4}; sched.G_lrate_dict = {1024: 0.0015}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 1200

##desc += '-preset-v2-1gpu'; num_gpus = 1; sched.minibatch_base = 4; sched.minibatch_dict = {4: 128, 8: 64, 16: 32, 32: 16, 64: 32, 128: 16, 256: 8, 512: 4}; sched.G_lrate_dict = {1024: 0.0015}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 12000
